...
namespace Brains
{
    class Programm
    {
        ...
        static void Main(string[] args)
        {
            ...
            Bitmap D = new Bitmap(@"D.bmp");
            Bitmap E = new Bitmap(@"E.bmp");
            Bitmap F = new Bitmap(@"F.bmp");
            Bitmap G = new Bitmap(@"G.bmp");
            Bitmap H = new Bitmap(@"H.bmp");
            Bitmap I = new Bitmap(@"I.bmp");
            Bitmap J = new Bitmap(@"J.bmp");
            Bitmap K = new Bitmap(@"K.bmp");
            Bitmap L = new Bitmap(@"L.bmp");
            Bitmap M = new Bitmap(@"M.bmp");
            Bitmap N = new Bitmap(@"N.bmp");
